...
const SelectedItem = ({ onClick, item, itemType, selectSpells }) => {
      ...
      <div>
        ...
        <FlexboxGrid align="middle">
          ...
          <FlexboxGrid.Item>
            <div>
              <FlexboxGrid align="middle">
                {Object.keys(item.activeSlots).map((slot, index) =>
                  renderAbilitySlot(item.activeSlots[slot], index, "active")
                )}
                {Object.keys(item.passiveSlots).map((slot, index) =>
                  renderAbilitySlot(item.passiveSlots[slot], index, "passive")
                )}
              </FlexboxGrid>
            </div>
          </FlexboxGrid.Item>
  ...
  return <List.Item>{item ? itemSelected() : noneSelected()}</List.Item>;
};
