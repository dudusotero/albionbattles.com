        ...
        <Container style={{}}>
          ...
          >
            <div style={{ paddingLeft: 20, paddingRight: 20 }}>
              This killboard is in beta. I have a google analytics tag running
              but it's only tracking page views, no data is stored. If you find
              any bugs or have any suggestions please contact me on discord:
              Alienzz#0001
            </div>
          </Footer>
        </Container>
