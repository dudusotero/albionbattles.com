      ...
      >
        <FlexboxGrid>
          <FlexboxGrid.Item
            ...
            xs={24}
          >
            <HighestDamagePlayer players={battle.highestDamagePlayer.players} />
          </FlexboxGrid.Item>
          <FlexboxGrid.Item
            style={{ marginBottom: "1rem" }}
            componentClass={Col}
            ...
            xs={24}
          >
            <HighestKills players={battle.highestKillsPlayer.players} />
          </FlexboxGrid.Item>
          <FlexboxGrid.Item
            style={{ marginBottom: "1rem" }}
            componentClass={Col}
          ...
          <FlexboxGrid.Item
            ...
            xs={24}
          >
            <HighestAssists players={battle.highestAssists.players} />
          </FlexboxGrid.Item>
        </FlexboxGrid>
      </FlexboxGrid.Item>
      <FlexboxGrid.Item
        ...
        xs={24}
      >
        <MostExpensiveDeath players={battle.mostExpensiveDeath} />
      </FlexboxGrid.Item>
    </FlexboxGrid>
  );
};
